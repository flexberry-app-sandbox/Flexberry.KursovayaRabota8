    ...
    modelClass.defineProjection('ВходВНомерE', 'i-i-s-kursovaya-rabota-вход-в-номер', {
      ...
      входГостя: (0, _attributes.hasMany)('i-i-s-kursovaya-rabota-вход-гостя', 'Вход гостя', {
        гость: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-гость', 'Гость', {
          регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', '', {
            номерКлюча: (0, _attributes.attr)('Карта', { index: 1 })
          }, { index: -1, hidden: true })
...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-rabota-\u0433\u043E\u0441\u0442\u044C', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    регистрацКлюча: _emberData.default.belongsTo('i-i-s-kursovaya-rabota-регистрац-ключа', { inverse: null, async: false })
  });
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('ГостьE', 'i-i-s-kursovaya-rabota-гость', {
      ...
      регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', 'Номер ключа', {}, { index: 5, displayMemberPath: 'номерКлюча' })
    });
    ...
    modelClass.defineProjection('ГостьL', 'i-i-s-kursovaya-rabota-гость', {
      ...
      телефон: (0, _attributes.attr)('Телефон', { index: 3 }),
      почта: (0, _attributes.attr)('E-mail', { index: 4 }),
      регистрацКлюча: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-регистрац-ключа', 'Номер ключа', {
        номерКлюча: (0, _attributes.attr)('Номер ключа', { index: 5 })
      }, { index: -1, hidden: true })
    });
  };
});
...
define('ember-app/mixins/regenerated/models/i-i-s-kursovaya-rabota-\u0440\u0435\u0433\u0438\u0441\u0442\u0440\u0430\u0446-\u043A\u043B\u044E\u0447\u0430', ['exports', 'ember-data', 'ember-cp-validations', 'ember-flexberry-data/utils/attributes'], function (exports, _emberData, _emberCpValidations, _attributes) {
  ...
  var Model = exports.Model = Ember.Mixin.create({
    ...
    номерКлюча: _emberData.default.attr('number'),
  ...
  var defineProjections = exports.defineProjections = function defineProjections(modelClass) {
    modelClass.defineProjection('РегистрацКлючаE', 'i-i-s-kursovaya-rabota-регистрац-ключа', {
      дата: (0, _attributes.attr)('Дата', { index: 0 }),
      номерКлюча: (0, _attributes.attr)('Ключ', { index: 1 }),
      срокДействия: (0, _attributes.attr)('Карта действует до:', { index: 5 }),
      комната: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-комната', 'Номер комнаты', {}, { index: 2, displayMemberPath: 'номерКомнаты' }),
      карта: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-карта', 'Номер карты', {}, { index: 3, displayMemberPath: 'номерКарты' }),
      считыватель: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-считыватель', 'Уникальный код', {}, { index: 4, displayMemberPath: 'уникальныйКод' }),
      сотрудник: (0, _attributes.belongsTo)('i-i-s-kursovaya-rabota-сотрудник', 'Ответственный', {}, { index: 6, displayMemberPath: 'фИО' })
    });
...
define('ember-app/mixins/regenerated/serializers/i-i-s-kursovaya-rabota-\u0433\u043E\u0441\u0442\u044C-offline', ['exports'], function (exports) {
  ...
  var OfflineSerializer = exports.OfflineSerializer = Ember.Mixin.create({
    getAttrs: function getAttrs() {
      var parentAttrs = this._super();
      var attrs = {
        регистрацКлюча: { serialize: 'id', deserialize: 'records' }
      };
...
define('ember-app/mixins/regenerated/serializers/i-i-s-kursovaya-rabota-\u0433\u043E\u0441\u0442\u044C', ['exports'], function (exports) {
  ...
  var Serializer = exports.Serializer = Ember.Mixin.create({
    getAttrs: function getAttrs() {
      var parentAttrs = this._super();
      var attrs = {
        регистрацКлюча: { serialize: 'odata-id', deserialize: 'records' }
      };
  ...
  exports.default = _offlineGlobals.default.extend({
    ...
    getOfflineSchema: function getOfflineSchema() {
      ...
      var returnedSchema = Ember.merge(parentSchema, {
        ...
        'i-i-s-kursovaya-rabota-гость': 'id,данныеПаспорта,датаРождения,почта,телефон,фИО,регистрацКлюча',
        ...
        'i-i-s-kursovaya-rabota-регистрац-ключа': 'id,дата,номерКлюча,срокДействия,карта,комната,сотрудник,считыватель',
